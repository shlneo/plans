...
def add_data_in_db(db):
    if is_db_empty():
        ...
        indicator_data = [
            ...
            (2, '1040', 'Топливо печное бытовое', 1.450, False, 1, None),
            (2, '1050', 'Мазут топочный', 1.370, False, 1, None),
            (2, '1060', 'Газы углеводородные нефтепереработки', 1.500, False, 1, None),
            (3, '1090', 'Газ природный', 1.150, False, 1, None),
            (3, '1110', 'Газ природный попутный', 1.300, False, 1, None),
            (2, '1150', 'Газы углеводородные сжиженные', 1.570, False, 1, None),
            (2, '1160', 'Уголь и продукты переработки угля', 1.000, False, 1, None),
            (4, '1620', 'Торф топливный фрезерный', 0.340, False, 1, None),
            (4, '1630', 'Торф топливный кусковой', 0.410, False, 1, None),
            (4, '1640', 'Брикеты и полубрикеты торфяные', 0.600, False, 1, None),
            (2, '1660', 'Кокс металлургический, коксик и коксовая мелочь', 0.990, False, 1, None),
            (5, '1680', 'Щепа топливная', 0.187, False, 1, None),
            (5, '1690', 'Дрова', 0.266, False, 1, None),
            (1, '1700', 'Прочие виды топлива - всего', 1.000, False, 1, None),
            (1, '1720', 'нефть сырая', 1.000, False, 1, None),
            (1, '1730', 'отходы лесозаготовок и деревообработки', 1.000, False, 1, None),
            (1, '1740', 'отходы с/х деятельности и прочие виды природного топлива', 1.000, False, 1, None),
            (1, '1741', 'древесный уголь', 1.000, False, 1, None),
            (1, '1742', 'древесные гранулы, пеллеты', 1.000, False, 1, None),
            (1, '1743', 'торфодревесное топливо', 1.000, False, 1, None),
            (1, '1745', 'биогаз', 1.000, False, 1, None),
            (1, '1750', 'метано-водородная фракция', 1.000, False, 1, None),
            (1, '1760', 'лигнин гидролизного производства', 1.000, False, 1, None),
            (1, '1770', 'Х-масла производства капролактама', 1.000, False, 1, None),
            (1, '1771', 'смесь эфиров и кислот', 1.000, False, 1, None),
            (1, '1772', 'метанольная фракция', 1.000, False, 1, None),
            (1, '1780', 'сульфатные и сульфитные щелока целлюлозно-бумажной промышленности', 1.000, False, 1, None),
            (1, '1791', 'нефтешлам', 1.000, False, 1, None),
            (1, '1793', 'адсорбированные отходы после очистных сооружений', 1.000, False, 1, None),
            (1, '1794', 'использованные автопокрышки', 1.000, False, 1, None),
            (1, '1795', 'прочие горючие отходы', 1.000, False, 1, None),
            
            (1, '1796', 'из него местные виды топлива и отходы', 1.000, True, 1.1, 1.1),       
            (1, '1797', 'из них возобновляемые', 1.000, True, 1.2, 1.2),
            
            (6, '1105', 'Электроэнергия израсходовано всего', 0.123, True, 2, 2),
            (6, '1405', 'Электроэнергия, выработанная собственными энергоисточниками, в том числе', 0.123, True, 2, None),
            (6, '1425', 'энергия воды, ветра, солнца, геотермальных источников', 0.123, True, 2, None),
            # (6, '1445', 'собственная выработка электроэнергии на АЭС', 0.123, True, 2, None),
            
            (7, '1104', 'Теплоэнергия израсходовано всего', 0.143, True, 3, 3),
            (7, '1404', 'Теплоэнергия, произведенная собственными энергоисточниками,  в том числе', 0.143, True, 3, None),
            (7, '1424', 'энергия воды, ветра, солнца, геотермальных источников', 0.143, True, 3, None),
            
            (1, '260', 'Суммарное потребление ТЭР', 1.000, True, 4, 4),
            
            (1, '9999', 'Годовая экономия ТЭР от энергосберегающих мероприятий всего', 1.000, True, 5, 5),
            (1, '9900', 'Ожидаемая экономия ТЭР от внедрения мероприятий в текущем году', 1.000, True, 5, None),
            (1, '9910', 'Экономия ТЭР от мероприятий предыдущего года внедрения, в том числе:', 1.000, True, 5, None),
            
            (1, '9911', 'январь-март', 1.000, True, 5, None),
            (1, '9912', 'январь-июнь', 1.000, True, 5, None),
            (1, '9913', 'январь-сентябрь', 1.000, True, 5, None),
            (1, '9914', 'январь-декабрь', 1.000, True, 5, None),

            (16, '9915', 'Целевой показатель энергосбережения', 1.000, True, 6, 6),
            (16, '9916', 'Целевой показатель по доле местных ТЭР в КПТ', 1.000, True, 7, 7),
            (16, '9917', 'Целевой показатель по доле возобновляемых источников энергии в КПТ', 1.000, True, 8, 8)
        ]
